...
#define ALPHA -1
#define QUANTUM 20
task_t *main_task, *curr, *dispatcher, *task_queue, *next;
...
void ppos_init() {
...
#endif
    action.sa_handler = select_next_task;
    ...
    timer.it_interval.tv_usec = 10000;  // disparos subsequentes, em micro-segundos
...
int task_switch(task_t *task) {
    ...
    task_t *aux = curr;
    if (task == dispatcher) dispatcher->activations += 1;
    curr = task;
#ifdef DEBUG
